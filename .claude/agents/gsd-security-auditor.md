...
**Verification depth scales with `asvs_level`** (see @/home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
