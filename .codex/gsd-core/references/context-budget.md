...
The keys live in `.codex/settings.json` (project) or `/home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/settings.json` (global) — **not** in `.planning/config.json`:
