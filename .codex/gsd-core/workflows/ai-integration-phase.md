...
<required_reading>
@/home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/gsd-core/references/ai-frameworks.md
@/home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/agents/gsd-eval-planner.md for instructions.
