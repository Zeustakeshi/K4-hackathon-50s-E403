...
- Usage: Reference from command with `@/home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/minhhieuano/2222/workspace/ai_in_action/Batch03-K4-AI-Product-Hackathon/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
